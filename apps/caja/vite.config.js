  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        '@foco': path.resolve(__dirname, '../foco/src'),
        '@': path.resolve(__dirname, './src'),
        '@caja/hub': path.resolve(__dirname, './src/hub'),
      },
