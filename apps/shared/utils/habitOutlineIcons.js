/**
 * Variantes outline de iconos de hábito para listas/sidebar.
 * El picker sigue usando los iconos filled de habitIcons.js.
 */
...
import { iconMap, HABIT_ICON_LEGACY_ALIASES } from './habitIcons.js';
...
const outlineIconMap = {
  ...
  Vacuum: HomeRepairServiceOutlinedIcon,
  DryCleaning: LocalLaundryServiceOutlinedIcon,
  ContentCut: ContentCutOutlinedIcon,
  BodyTrim: ContentCutOutlinedIcon,
  Unas: ContentCutOutlinedIcon,
  Barba: ContentCutOutlinedIcon,
  Salon: FaceRetouchingNaturalOutlinedIcon,
  Grass: GrassOutlinedIcon,
  Yard: YardOutlinedIcon,
  Cream: MedicationLiquidOutlinedIcon,
  Perfume: AutoAwesomeOutlinedIcon,
  ...
  Fruit: EmojiNatureOutlinedIcon,
  Vegetables: AgricultureOutlinedIcon,
...
export function getOutlineIconByName(iconName) {
